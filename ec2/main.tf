...
resource "null_resource" "provisioner" {
  depends_on = [aws_route53_record.ec2]
...
#      "sudo bash ${var.component}.sh ${var.password}"
    "ansible-pull -i localhost, -U https://github.com/rohangupta1996/roboshop-ansible.git roboshop.yml -e role_name=${var.component} -e env=${var.env}"
    ...
    "Statement" : [
      {
        ...
        "Resource" : "arn:aws:ssm:us-east-1:232420610940:parameter/${var.env}.${var.component}*"
      },
      {
        "Sid" : "VisualEditor1",
        "Effect" : "Allow",
